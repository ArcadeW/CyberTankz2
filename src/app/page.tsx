...
export default function Home() {
  ...
  <!-- Free Nickname Box -->
  <div class="flex flex-col items-center justify-center w-full sm:w-auto p-5 bg-gray-100 rounded shadow-lg mx-2 mb-4">
    <img
    ...
    <a
      ...
      class="reserve-btn px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700"
    >
